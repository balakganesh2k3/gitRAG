...
import { createGitHubClient, fetchRepository, processRepositoryWithRAG } from "../../lib/github-api";
...
const RepositoryManager = () => {
    ...
    const handleAddRepository = async (e) => {
        ...
        try {
            ...
            const ragResult = await processRepositoryWithRAG(apiClient, owner, repo);
